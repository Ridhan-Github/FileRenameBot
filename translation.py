...
"""
    ...
    SAVED_RECVD_DOC_FILE = "<b> ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ </b>"
    REPLY_TO_DOC_FOR_RENAME_FILE = "<b> Rᴇᴘʟʏ ᴛᴏ ᴛʜᴀᴛ ꜰɪʟᴇ ᴡɪᴛʜ /rename ɴᴇᴡ ꜰɪʟᴇɴᴀᴍᴇ.ᴇxᴛᴇɴsɪᴏɴ </b>"
    REPLY_TO_FILE_FOR_CONVERT = "<b> Rᴇᴘʟʏ ᴛᴏ ᴛʜᴀᴛ ꜰɪʟᴇ ᴡɪᴛʜ /convert ᴄᴏᴍᴍᴀɴᴅ </b>"
    CUSTOM_CAPTION_UL_FILE = " ᴛʜᴀɴᴋ ʏᴏᴜ ғᴏʀ ᴜsᴇ ᴍᴇ /n/nᴊᴏɪɴ - https://t.me/DisneyBots  "
    NO_THUMB_FOUND = "Nᴏ ᴛʜᴜᴍʙɴᴀɪʟ ꜰᴏᴜɴᴅ 😟"
    IFLONG_FILE_NAME = """ᴅᴇᴄʀᴇᴀᴄᴇ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴏғ ʟᴇᴛᴛᴇʀs"""
    CCAPTION_HELP = """ <b> sᴇᴛ ᴄᴜsᴛᴏᴍ ᴄᴀᴘᴛɪᴏɴ ғᴏʀ ᴜsᴇ /scaption ᴄᴏᴍᴍᴀɴᴛ </b> """
